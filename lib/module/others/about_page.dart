                ...
                child: Column(
                  children: [
                    QlVisible(
                      ...
                      childReplace: Material(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            try {
                              await launchUrl(Uri.tryParse("https://github.com/LinxiDev/qinglong-app/wiki/qinglong-app%E2%80%90Wiki")!);
                            } catch (e) {
                              logger.e(e);
                            }
                          },
                    ...
                    Material(
                      ...
                      child: InkWell(
                        onTap: () {
                          _launchURL("https://github.com/LinxiDev/qinglong-app/wiki/qinglong-app%E2%80%90Wiki");
                        },
                        child: Padding(
                          padding: const EdgeInsets.symmetric(
                            vertical: 10,
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          if (Platform.isAndroid) {
                            Share.share("分享一款好用的青龙客户端，快去点击下面的链接地址下载吧 https://github.com/LinxiDev/qinglong-app/wiki/qinglong-app%E2%80%90Wiki");
                          } else {
